 ...
 * @return {Object} An object with methods to manage the image slider.
 */
const imageSlider = (height, width, ...images) => {
   ...
   * @return {number} An interval ID that can be used with clearInterval to stop the automatic image updates.
   */
  const auto = (ms = 1000) => {
